"""Shared fixtures for the Pathwise backend test suite.
...
real pathwise.db. Groq is never called: tests either exercise endpoints that do
...
TEST_DB = TESTS_DIR / "_test_pathwise.db"
